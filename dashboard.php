...
<body>
    <div class="login-container">
        ...
        <?php if (strpos($user['roles'], 'demandeur') !== false) : ?>
            <div style="margin: 30px 0; padding: 25px; background: #1a2332; border: 3px solid #3d5a80; border-radius: 8px;">
                <h2 style="color: #ffffff; margin-bottom: 15px; font-size: 28px; font-weight: 700;">Mes demandes</h2>
                <p style="color: #ffffff; margin-bottom: 20px; font-size: 18px; font-weight: 600;">Vous pouvez créer des demandes d'aide.</p>
        ...
        <?php if (strpos($user['roles'], 'benevole') !== false) : ?>
            <div style="margin: 30px 0; padding: 25px; background: #1a2332; border: 3px solid #3d5a80; border-radius: 8px;">
                <h2 style="color: #ffffff; margin-bottom: 15px; font-size: 28px; font-weight: 700;">Missions disponibles</h2>
                <p style="color: #ffffff; margin-bottom: 20px; font-size: 18px; font-weight: 600;">Vous pouvez accepter des missions et gagner des points.</p>
                <a href="missions.php" style="text-decoration: none;"><button type="button">Voir les missions disponibles</button></a>
                <a href="mes_propositions.php" style="text-decoration: none;"><button type="button">Mes propositions en attente</button></a>
