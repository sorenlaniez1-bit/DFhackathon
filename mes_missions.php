        ...
        <?php else : ?>
            <?php foreach ($missions as $mission) : ?>
                <div class="demande-card">
                    ...
                    <div class="demande-info" style="background: #fffbeb; padding: 10px; border-radius: 8px; border: 2px solid #000;">
                        <strong>📍 Adresse complète :</strong> <?php echo htmlspecialchars($mission['lieu']); ?>
                    </div>
                    ...
                    <?php if ($mission['statut'] == 'prise_en_charge') : ?>
                        <div class="actions-buttons">
                            <p style="color: #000; font-weight: 600; margin-bottom: 10px;">Cette mission est en cours. Le demandeur vous contactera et validera la mission une fois terminée.</p>
                        </div>
                    <?php endif; ?>
                </div>
            <?php endforeach; ?>
